...
CATEGORIES: dict[str, list[str]] = {
    ...
    "🎬 Entertainment": [
        ...
        "סינמטק", "בארד פרודקשנס-יציל", "רשות הטבע והגנים הר הכרמל", 
        "רשות הטבע והגנים - מבצר נמרוד","רשות הטבע והגנים ציפורי",
        "רשות הטבע והגנים יחיעם", "רשות הטבע והגנים חוף אכזיב",
        "חניון קניון סינמול",
    ],
